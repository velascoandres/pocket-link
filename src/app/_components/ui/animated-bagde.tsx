...
export const AnimatedBagde = ({
  ...
  return (
    <span role={role} onClick={onClick}  className={`relative inline-flex overflow-hidden rounded-full p-[2px] ${className}`}>
      ...
      ></span>
      <div className="bg-gray-950 inline-flex items-center justify-center w-full px-4 py-2 text-lg text-green-800 rounded-full cursor-pointer text-white/80 backdrop-blur-3xl whitespace-nowrap">
        {children}
      </div>
    </span>
  )
