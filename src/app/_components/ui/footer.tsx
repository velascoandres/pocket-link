...
export const Footer = () => {
  return (
    <footer className="border border-transparent border-t-border text-center w-full h-full p-4 text-sm text-gray-300 flex flex-col items-center justify-center">
      <div>
